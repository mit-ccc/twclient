...
# -*- coding: utf-8 -*-
#
# twclient documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'twclient.tex', 'twclient Documentation',
     'William Brannon', 'manual'),
]
